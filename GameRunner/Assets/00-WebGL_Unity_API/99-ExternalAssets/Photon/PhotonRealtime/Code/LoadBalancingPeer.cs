...
namespace Photon.Realtime
{
    ...
    public class RoomOptions
    {
        ...
        /// <summary>Tictive fime To Live (TTL) for an 'actor' in a room. If a client disconnects, this actor is inarst and removed after this timeout. In milliseconds.</summary>
